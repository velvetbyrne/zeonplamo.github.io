    ...
    <table id="menu" class="table table-striped table-bordered" style="width:90%">
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                echo "<tr> <td> <img src=".$row["foto"]." width='200' height='200' style='display: block; margin-left: auto; margin-right: auto;'> </td> <td>". $row["nama"]. "</td>"."<td>" .$row["tipe"] . "</td> <td>" .$row["harga"] . "</td> <td> <button type='button' onclick='addtocart()'><img src='/uts/asset/add.png'></button><button type='button' onclick='deletcart()'><img src='/uts/asset/remove.png'></button> </td> </tr>";
            }   
        } else {
            echo "0 results";
        }
